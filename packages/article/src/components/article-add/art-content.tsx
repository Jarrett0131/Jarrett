  ...
  return (
    <div className={styles.artContent}>
      <Spin spinning={submitting} delay={200} >
        ...
        modules={modules} 
        />
        <LargeFileUpload onUploaded={setArticleAttachment} />
