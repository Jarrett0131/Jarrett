...
import useArtAddStore, { selectCurrent,ArticleSteps,selectHasHydrated,clearArticle, setCurrent,resetCurrent} from '@article/store/art-add-store';
import { Steps,message,FloatButton, Modal} from 'antd';
import ArticleBase from '@article/components/article-add/art-base';
import { getCateListApi } from '@article/api/cate-api.ts';
import to from 'await-to-js';
import ArticleCover from '@article/components/article-add/art-cover';
import ArticleContent from '@article/components/article-add/art-content';
import { postArticleApi } from '@article/api/article-api.ts';
import type { ArtAddStore } from '@article/store/art-add-store.ts';
import localforage from '@shared/utils/localforage';
import type { StorageValue } from 'zustand/middleware';
import ClearOutlined from '@ant-design/icons/es/icons/ClearOutlined';
import ArticleResult from '@article/components/article-add/art-result';
