...
import { getCateListApi,postCateApi,editCateApi,delCateApi} from '@article/api/cate-api.ts';
import to from 'await-to-js';
import { useLoaderData ,Await} from 'react-router-dom';
import { Table ,Space,message } from 'antd';
import type { TableProps } from 'antd';
import ButtonAdd from '@article/components/article-cate/btn-add';
import type { ActionFunctionArgs } from 'react-router-dom';
import ButtonEdit from '@article/components/article-cate/btn-edit';
import ButtonDelete from '@article/components/article-cate/btn-del';
