...
import { initArticle } from '@article/store/art-edit-store';
import { useBeforeUnload ,useBlocker} from 'react-router-dom';
import { useCallback , useEffect ,useRef } from 'react';
import type { LoaderFunctionArgs } from 'react-router-dom';
import { stepItems } from './article-add';
import { Steps ,Modal,message} from 'antd';
import useArticleEditStore, { selectCurrent ,resetCurrent,updateCurrent } from '@article/store/art-edit-store';
import { getCateListApi } from '@article/api/cate-api.ts';
import { ArticleSteps } from '@article/store/art-add-store'
import to from 'await-to-js';
import EditBase from '@article/components/article-edit/art-base';
import EditCover from '@article/components/article-edit/art-cover';
import EditContent from '@article/components/article-edit/art-content';
import { putArticleApi } from '@article/api/article-api';
import EditResult from '@article/components/article-edit/art-result';
